        ...
        <div class="container-fluid tt-top-line">
            <div class="row">
                <div class="tt-logo-container">
                    <!-- mobile logo -->
                    <a class="tt-logo tt-logo-alignment" href="/"><img src="{{asset('/images/custom/logo.png')}}" alt="The Optical Fiber"></a>
                    <!-- /mobile logo -->
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="tt-header-holder">
                <div class="tt-col-obj tt-obj-logo">
                    <!-- logo -->
                    <a class="tt-logo tt-logo-alignment" href="index.html"><img src="{{asset('/images/custom/logo.png')}}" alt="The Optical Fiber"></a>
                    <!-- /logo -->
                </div>
                                    ...
                                    <form>
                                        ...
                                        <div class="search-results">
                                            <ul>
                                                <li>
                                                    <a href="product.html">
                                                        <div class="thumbnail"><img src="{{ asset('/images/loader.svg')}})" data-src="{{asset('/product/product-03.jpg')}}" alt=""></div>
                                                ...
                                                <li>
                                                    <a href="product.html">
                                                        <div class="thumbnail"><img src="{{asset('/images/loader.svg')}}" data-src="{{asset('/product/product-02.jpg')}}" alt=""></div>
                                                        <div class="tt-description">
                                                            <div class="tt-title">Flared Shift Bag</div>
                                                            <div class="tt-price">
                                                                $24
                                        ...
                                        <div class="tt-cart-content">
                                            <div class="tt-cart-list">
                                                ...
                                                <div class="tt-item">
                                                    <a href="product.html">
                                                        <div class="tt-item-img">
                                                            <img src="{{asset('/images/loader.svg')}}" data-src="images/product/product-02.jpg" alt="">
                                                        </div>
                                                        <div class="tt-item-descriptions">
                                                            <h2 class="tt-title">Flared Shift Dress</h2>
                                                            <ul class="tt-add-info">
