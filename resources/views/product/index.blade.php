    ...
    <div class="container-indent" style="margin-bottom: 35px">
        <div class="container">
            <div class="row tt-layout-promo-box">
                <div class="col-md-6">
                    <a href="#" class="tt-promo-box tt-one-child">
                        <img src="{{'assets/images/loader.svg'|theme}}" data-src="{{'assets/images/promo/index04-promo-img-05.jpg'|theme}}" alt="">
                        <div class="tt-description">
                            <div class="tt-description-wrapper">
                                <div class="tt-background"></div>
                ...
                <div class="col-md-6">
                    <a href="listing-left-column.html" class="tt-promo-box tt-one-child">
                        <img src="{{'assets/images/loader.svg'|theme}}" data-src="{{'assets/images/promo/index04-promo-img-06.jpg'|theme}}" alt="">
                        <div class="tt-description">
                            <div class="tt-description-wrapper">
                                <div class="tt-background"></div>
